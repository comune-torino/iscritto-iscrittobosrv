...
set CSI_SWAGGER_GEN_HOME=D:\devtools\csi-swagger-codegen
...
java -cp %SWAGGER_CP% %DEBUG_OPTS% io.swagger.codegen.SwaggerCodegen generate -i ..\src\yaml\iscrittobosrv.yaml -l jaxrs-resteasy-eap-csi -o .. --config swagger_config_java.json

rem echo
rem pause "#### generazione stub angular2 ####"
rem java -cp %SWAGGER_CP% %DEBUG_OPTS% io.swagger.codegen.SwaggerCodegen generate -i ..\src\yaml\corsospa.yaml -l typescript-angular -o ..\..\lgspaapi --config swagger_config_angular.json 

rem echo
rem pause "#### generazione documentazione html ####"
rem java -jar %SWAGGER_CP% generate -l html -i ..\src\yaml\corsospa.yaml -o ..\temphelp